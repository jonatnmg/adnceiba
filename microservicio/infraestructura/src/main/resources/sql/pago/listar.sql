...
I.id as id_inmueble, I.numero_predial, I.direccion, I.area_total, I.area_construida, I.avaluo_catastral,
T.id as id_tarifa, T.avaluo_minimo, T.avaluo_maximo, T.valor_tarifa, T.anio as anio_tarifa
from pago AS PA
